...
Researchers from Inria Bordeaux and CNRS are conducting this study to investigate how people perceive scrollable bar charts.

**Project manager(s)**: Yvonne Jansen, CNRS Researcher; Leni Yang, Inria Post-Doc; Pierre Dragicevic, Inria Researcher

**Project team**: Bivwac, Inria at the University of Bordeaux

**Project name**: Scrollable bar charts perception

**Study procedure**
You will view a series of bar charts on your computer, some of which require scrolling. After each chart, you will be asked to estimate the ratio between the heights of the bars. Your responses will help us understand how people perceive scrollable bar charts.
...
**Compensation**
You will receive a financial compensation of £2.30 for an estimated completion time of about 7-13 minutes, under the condition that you complete the experiment. However, compensation will be withheld if responses appear unrelated to the stimuli, suggesting the charts were ignored.
...
If you decide to stop the experiment before full completion, your data will be deleted.
...
### CONTACT PERSONS
Leni Yang, Post-Doctoral researcher, leni.yang@inria.fr

Jansen Yvonne, Research scientist, yvonne.jansen@inria.fr

Pierre Dragicevic, Research scientist, pierre.dragicevic@inria.fr
