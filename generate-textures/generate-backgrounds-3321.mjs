...
// Tutorial ratios for study 3; pass CLI args to generate a subset.
const DEFAULT_RATIOS = [2, 13, 90, 100, 4000];
...
const TEXTURE_MODULE_PATH = '/public/pvr-study-3321/textureGenerator.js';
...
const outputDir = path.join(repoRoot, 'public', 'pvr-study-3321', 'assets');
...
async function main() {
  ...
  const ratiosToGenerate = cliRatios.length > 0 ? cliRatios : DEFAULT_RATIOS;
